  ...
  return (
    <div className="space-y-3">
      <p className="font-code text-sm text-gray-400 leading-relaxed">
        {strings.HOWTO_INTRO_TEXT_PART1}{" "}
        <span className="text-crown-gold">{strings.ENTER_TEXT}</span>{" "}
        {strings.HOWTO_INTRO_TEXT_PART2}
      </p>

      <div className="border-t border-obsidian-700" />

      <p className="font-pixel text-xs text-crown-amber tracking-widest">
        {strings.HOWTO_PAINT_HEADING}
      </p>
      <p className="font-code text-sm text-gray-400 leading-relaxed">
        {strings.HOWTO_PAINT_DESCRIPTION}
      </p>
      ...
      <div className="space-y-2">
        <div className="flex items-center gap-3">
          ...
          <span className="font-code text-xs text-gray-400">
            {strings.HOWTO_GREEN_DESCRIPTION}
          </span>
        </div>
        <div className="flex items-center gap-3">
          ...
          <span className="font-code text-xs text-gray-400">
            {strings.HOWTO_YELLOW_DESCRIPTION}
          </span>
        </div>
        <div className="flex items-center gap-3">
          ...
          <span className="font-code text-xs text-gray-400">
            {strings.HOWTO_GRAY_DESCRIPTION}
          </span>
        </div>
      </div>
      ...
      <p className="font-pixel text-xs text-crown-amber tracking-widest">
        {strings.HOWTO_ROW_TOOLS_HEADING}
      </p>

      <div className="flex items-center gap-3">
        <RecycleIcon className="w-8 h-8 shrink-0 text-gray-400" />
        <span className="font-code text-xs text-gray-400">
          {strings.HOWTO_CLEAR_ROW_DESCRIPTION}
        </span>
      </div>
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="font-code text-xs text-gray-400">
          {strings.HOWTO_BADGE_COUNT_DESCRIPTION}
        </span>
      </div>
      ...
      <p className="font-pixel text-xs text-crown-amber tracking-widest">
        {strings.HOWTO_KEYBOARD_HEADING}
      </p>
      <p className="font-code text-xs text-gray-400">
        {strings.HOWTO_KEYBOARD_DESCRIPTION}
      </p>
    </div>
  );
};
